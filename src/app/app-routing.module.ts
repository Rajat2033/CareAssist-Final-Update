...
const routes: Routes = [
  ...
  { path: 'admin/dashboard', component: AdmindashboardComponent, children: [  { path: 'registercompany', component: RegisterCompanyComponent },
  { path: 'registerprovider', component: RegisterProviderComponent },{path:'addadmin',component:AddadminComponent},{ path: 'getallcompanies', component: GetAllCompaniesComponent }, { path: 'getallpatients', component: GetAllPatientsComponent }, { path: 'getallclaims', component: GetAllInsuranceClaimsComponent }, { path: 'getallproviders', component: GetAllProvidersComponent }, { path: 'getallplans', component: GetAllInsurancePlansComponent }, { path: 'getallinvoices', component: GetAllInvoicesComponent }] },
