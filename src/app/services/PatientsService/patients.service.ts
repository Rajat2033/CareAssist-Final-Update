...
export class PatientsService {
  ...
  patientURL: string = 'http://localhost:6767/api/v1/patients';
  ...
  sendEmailOnRegistration(patientId: number):Observable<boolean> {
    return this.http.get<boolean>(this.patientURL+`/sendemail/registration/${patientId}`);
}
