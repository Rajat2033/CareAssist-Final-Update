	...
	public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
		return http.csrf().disable()
                ...
                .requestMatchers("/v3/api-docs/**", "/swagger-ui/**", "/swagger-resources/**",
                         "/api/v1/patients/add/new", "/api/v1/patients/sendemail/registration/{patientId}", "/api/v1/patients/get/allPatients",
                        "/api/v1/login/authenticate",
                        "/api/v1/login/getrole/{username}",
                        "/api/v1/admin/add", "/api/v1/adminmedical/getallpatients", "/api/v1/adminmedical/getallinsuranceplans",
